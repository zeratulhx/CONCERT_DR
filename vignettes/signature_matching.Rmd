...
# Signature Matching with DRnew

This vignette demonstrates how to match drug response signatures against reference profiles extracted from the CMap database using the DRnew package. We'll cover the various matching methods available and how to interpret the results.
...
DRnew provides access to various signature matching methods through the RCSM package:
...
For convenience, DRnew provides a function that combines the extraction and matching steps:
...
You can create visualizations of your results (not included in DRnew, but using standard R plotting):
...
If you're not sure which methods to use, DRnew provides an interactive selection function:
