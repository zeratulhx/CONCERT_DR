---
title: "Introduction to DRnew"
author: "Hengxin Pan"
date: "`r Sys.Date()`"
output: BiocStyle::html_document
vignette: >
  %\VignetteIndexEntry{Introduction to DRnew}
...
To install the latest version of DRnew from Bioconductor:
...
The DRnew package is organized into several main components:
